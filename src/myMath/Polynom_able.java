...
public interface Polynom_able extends cont_function{
	 ...
	 * @throws DataException 
	 */
	public void add(Monom m1) throws DataException;
	 ...
	 * @return new polynom that copy of the exist Polynom
	 * @throws DataException 
	 */
	 ...
	 * @return new polynom that is derivative of the exist polynom
	 * @throws DataException 
	 */
